#' mys: mean years of schooling people with disabilities in Papua Island
#'
#' A dataset containing the mean years of schooling people with disabilities in Papua Island in 2021
#'
#' @format
#' A data frame with 42 rows and 7 variables :
#'
#' \describe{
